...
from trip.exceptions.custom_exceptions import InvalidAdminUser, InvalidUser, InvalidDestination, InvalidRating
...
from trip_gql.rating.types.types import AddRatingParams, AddRatingResponse, Rating, RatingNotValid
...
class AddRating(graphene.Mutation):
    ...
    def mutate(root, info, params):
        ...
        try:
            ...
            return RatingNotValid(rating=params.rating)
