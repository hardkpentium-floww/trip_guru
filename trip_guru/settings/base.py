"""
Django settings for trip_guru project.
...
ALLOWED_HOSTS = [
    "trip-guru-prod.apigateway.in",
    "trip-guru-alpha.apigateway.in",
    "trip-guru-beta.apigateway.in",
    "trip-guru-gamma.apigateway.in",
    "trip-guru-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]

ROOT_URLCONF = 'trip_guru.urls'

CSRF_COOKIE_SECURE = False

WSGI_APPLICATION = 'trip_guru.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [trip_guru - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
TRIP_GURU_SOURCE = "trip-guru-source"
